...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id_classes'])) {
    // Récupérer l'ID de la classe à supprimer
    $id_classes = $_POST['id_classes'];

    // Préparer la requête de suppression
    $sql = "DELETE FROM classes WHERE id = $id_classes";

    // Exécuter la requête de suppression
    if (mysqli_query($conn, $sql)) {
        echo "La classe avec l'ID $id_classes a été supprimée avec succès.";
    } else {
...
$reqSQL = "SELECT id, nom_de_classe FROM classes ORDER BY id";
